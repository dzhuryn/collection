...
//<?php
/*
Tree Configuration where show module on doc click
Tree Configuration where hide childrensjavascript:;
Configuration
{"parent":"","template":"","id":""}

Controllers Configuration	
{
	"news":{"parent":"","template":"","id":""},
	"product":{"parent":"","template":"","id":""}
}
*/

require MODX_BASE_PATH.'assets/modules/collections/collections.plugin.php';
